...
Completed: fixed-work parity passed for every root and both passes (identical
nodes, completed depths, scores and moves). Aggregate speedup was1.046255,
below the predeclared1.10 gate. No matches, ZIP or promotion. Baseline times
5.119542/4.890040s; cache4.893915/4.673144s. Five correctness tests passed20.88s.
Preserve this result; no unchanged retries. Exact evaluation reuse helped only
modestly on this workload. Next reduce the cost of evaluating pawn structure
itself, without depending on cache hits. No NN fit or data collection is justified
by this exact-equivalence performance experiment.
