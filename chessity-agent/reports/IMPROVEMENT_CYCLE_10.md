...
Completed: rejected. All11 correctness tests passed in50.07 seconds. At one
second per position, baseline and prototype both repeated all11 errors, including
all3 recent competition errors. Mean completed depth rose from6.455 to6.636,
but the cheap decision gate failed. No further teacher work, training, match
games, ZIP or promotion followed. This unchanged idea must not be rerun.

Critique: this conservative pruning policy did not save enough useful work.
Learning was not changed because no new evaluation deficiency was established
by this pilot. Existing targeted data was sufficient to reject it cheaply.
Next investigate exact static-evaluation reuse; full position evaluation is
history independent and need not share the search table's strict history gate.
