"""Review the completed cycle35 pair once, with bounded teacher work."""
import json
...
def main():
    ...
    out = run / 'cycle-35-review'
    source = run / 'cycle-35-pair/comparison-compiled-near-queen-checks-v1/results.json'
    controller = run / 'near-queen-checks-practical-controller/controller.json'
    ...
    paths = ['scripts/near_queen_checks_review.py', 'scripts/improvement_audit.py',
             ...
             'configs/near-queen-checks-review-cycle.json',
             'docs/NEAR_QUEEN_CHECKS_REVIEW_20260908.md']
    ...
    try:
        ...
        assert result['own_moves'] == count and result['games'] == 2
