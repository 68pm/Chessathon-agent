...
nominal2600. All16 games were replayed and frozen sources/clock accounting verified.
...
The rated audit found5 stable >=200cp mistakes in304 own decisions. Its successor
pilot accepted4 of5 pairs, leaving a total of8 verified pairs across the two recent
...
Then audit the8 rated games. At most2 concurrent games; no teacher/training during
...
Gate passed:21 core tests in24.22s, including poisoned context/halfmove scores and
an illegal stored hint; all16 audited positions matched v1.41 at completed depth4.
At1s per position, repeated original choices fell from14/16 to13/16, mean completed
depth rose from6.25 to6.4375, and visited nodes rose from7,560,192 to9,053,184.
