# Competition-first development — 7 September 2026
...
latest 2–3 matches, which the user says use more recent bots. Older matches used
...
repeat them. The latest actual competition rounds54–56 were also saved and
...
read-only package check. It is playing a two-game colour pair versus41. Completed
...
Prefer a bounded tactical/position gate and2–4 preliminary comparison games to
reject weak ideas quickly. A promising potential competition upload can receive
an8–12-game fresh practical check, subject to the user's deadline. Report the small
