"""Shorter bounded screen after measured overnight stage runtimes; never selects a release."""
...
def run(directory):
    ...
    source_paths = [Path(__file__), ROOT / OPENINGS, ROOT / 'scripts/overnight_clock_quality.py',
        ...
        ROOT / 'docs/OVERNIGHT_PORTABLE_SCREEN_20260909.md',
        ROOT / 'docs/OVERNIGHT_OPT1_STARTUP_PLAN_20260909.md', ROOT / 'training/game_feedback.py',
    ...
    def match(label, stage_name, pairs, offset, levels=None):
        ...
        stage(label, args, 2700 if stage_name == 'comparison' else 1500)
