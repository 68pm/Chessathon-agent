"""Single bounded direct-check ordering pilot, preserving all outcomes."""
import json
import os
import statistics
import subprocess
...
def main():
    out = ROOT / 'runs/improvement-loop-20260907/cycle-25'
    ...
    try:
        ...
        xml = out / 'tests.xml'
        child(['-m', 'pytest', 'tests/test_direct_check_order.py', '-q', '--junitxml', str(xml)], out / 'tests.log')
