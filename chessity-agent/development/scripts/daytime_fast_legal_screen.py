...
SOURCE = ROOT / 'runs/daytime-20260909/fast-legal-01'
QUALITY = ROOT / 'runs/daytime-20260909/fast-legal-quality-01'
OUT = ROOT / 'runs/daytime-20260909/fast-legal-screen-01'
...
def prepare():
    ...
    for directory in (SOURCE, QUALITY):
        ...
        supervisor = directory.parent / ('fast-legal-supervisor-01' if directory == SOURCE else 'fast-legal-quality-supervisor-01') / 'supervisor.json'
    ...
    OUT.mkdir()
    package = OUT / 'fast-legal-candidate.zip'
    ...
    paths = [Path(__file__), ROOT / 'scripts/daytime_common.py',
        ROOT / 'tests/test_daytime_fast_legal_screen.py', ROOT / 'docs/DAYTIME_FAST_LEGAL_SCREEN_20260909.md',
...
def run():
    ...
    def match(row):
        ...
        cycle = 'd9-fast-legal-01-' + row['label']
