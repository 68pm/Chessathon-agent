...
OUT = ROOT / 'runs/e55-trained-rematch-20260908'
...
def main():
    ...
    try:
        ...
        child(['-X', 'utf8', '-m', 'scripts.validate_package', '--zip', str(OUT / 'candidate.zip'),
