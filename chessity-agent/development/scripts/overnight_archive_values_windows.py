...
OUT = ROOT / 'runs/overnight-20260909/archive-values-02'
...
def prepare():
    ...
    prep['source_sha256'].update({str(p.relative_to(ROOT)):digest(p) for p in (
        SOURCE, marker, Path(__file__), ROOT / 'docs/OVERNIGHT_ARCHIVE_VALUES_WINDOWS_20260909.md', ROOT / 'docs/OVERNIGHT_ARCHIVE_VALUES_20260909.md')})
