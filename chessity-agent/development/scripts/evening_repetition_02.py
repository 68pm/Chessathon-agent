...
def prepare():
    ...
    experiment=ROOT/'experiments/evening_repetition_02_core.py'
    ...
    paths=[Path(__file__),Path(trial.__file__),ROOT/'scripts/evening_common.py',
        ...
        ROOT/'tests/test_evening_repetition_02.py',ROOT/'docs/EVENING_REPETITION_PLAN_20260909.md',
...
class Worker(trial.WarmWorker):
    def __init__(self,label):
        ...
        self.process=subprocess.Popen([sys.executable,'-X','utf8','-m','scripts.evening_repetition_02',
