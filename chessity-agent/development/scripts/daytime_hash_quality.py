"""Review completed incremental-hash clock choices before any playing test."""
import argparse
import json
import statistics
...
SOURCE = ROOT / 'runs/daytime-20260909/incremental-hash-02'
OUT = ROOT / 'runs/daytime-20260909/hash-quality-01'
