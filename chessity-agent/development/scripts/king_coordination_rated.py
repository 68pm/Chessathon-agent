"""Four frozen v1.52 games at nominal2400/2600, with per-launch capacity guards."""
import json
import sys
...
def main():
    out = ROOT / 'runs/improvement-loop-20260907/king-coordination-rated-controller'
    ...
    try:
        ...
        sys.argv = ['overnight_matches', '--candidate', prep['candidate'], '--stage', 'rated',
            '--pairs', '1', '--cycle', 'king-coordination-rated-01', '--levels', '2400', '2600',
            '--openings', 'configs/king-coordination-rated-openings.json']
        overnight_matches.main()
        path = ROOT / 'runs/improvement-loop-20260907/king-coordination-rated-01/rated-compiled-king-coordination-v1/results.json'
