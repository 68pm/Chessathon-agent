"""Review completed piece-square clock choices before any playing test."""
import argparse
import json
import statistics
...
SOURCE = ROOT / 'runs/daytime-20260909/piece-square-01'
OUT = ROOT / 'runs/daytime-20260909/piece-square-quality-01'
...
def prepare():
    ...
    assert json.loads((SOURCE.parent / 'piece-square-supervisor-01/supervisor.json').read_text())['status'] == 'complete'
