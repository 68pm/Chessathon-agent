...
def main():
    out = ROOT / 'runs/improvement-loop-20260907/cycle-23-credit-checks'
    ...
    try:
        ...
        xml = out / 'tests.xml'
        previous_xml = ROOT / 'runs/improvement-loop-20260907/cycle-23/tests.xml'
        ...
        child(['-m', 'pytest', 'tests/test_check_extension_credits.py', '-q', '--junitxml', str(xml)], out / 'tests.log')
        ...
        save_json(out / 'combined-correctness.json', dict(passed=True, retained_passed_cases=8,
            ...
            candidate_files=prep['prototype_files'], note='Only Python observer uint64 conversion corrected; compiled code unchanged.'))
