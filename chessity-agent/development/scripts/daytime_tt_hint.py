...
def prepare():
    ...
    paths=[Path(__file__),ROOT/'scripts/daytime_tt_hint_transform.py',
        ROOT/'scripts/daytime_common.py',ROOT/'tests/test_daytime_tt_hint.py',
        ROOT/'docs/DAYTIME_TT_HINT_PLAN_20260909.md',experiment,previous,probe,
...
class WarmWorker:
    def __init__(self, label):
        ...
        self.process = subprocess.Popen([sys.executable, '-X', 'utf8', '-m', 'scripts.daytime_tt_hint',
