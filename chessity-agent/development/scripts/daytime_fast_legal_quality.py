"""Review completed fast-legal clock choices before any playing test."""
import argparse
import json
import statistics
...
OUT = ROOT / 'runs/daytime-20260909/fast-legal-quality-01'
...
def prepare():
    ...
    assert json.loads((SOURCE.parent / 'fast-legal-supervisor-01/supervisor.json').read_text())['status'] == 'complete'
