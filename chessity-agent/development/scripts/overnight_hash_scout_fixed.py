...
OUT = ROOT / 'runs/overnight-20260909/hash-scout-02'
...
def prepare():
    ...
    experimental = ROOT / 'experiments/overnight_hash_scout_core_v2.py'
...
class WarmWorker:
    def __init__(self, label):
        ...
        self.process = subprocess.Popen([sys.executable, '-X', 'utf8', '-m', 'scripts.overnight_hash_scout_fixed',
