...
SOURCE = ROOT / 'runs/daytime-20260909/contact-mate-01'
OUT = ROOT / 'runs/daytime-20260909/contact-mate-quality-01'
...
def prepare():
    ...
    assert json.loads((SOURCE.parent / 'contact-mate-measure-supervisor-01/supervisor.json').read_text())['status'] == 'complete'
