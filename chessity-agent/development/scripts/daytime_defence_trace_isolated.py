...
def run():
    ...
    # Capacity imports project feature helpers. This isolated worker must load
    # the frozen candidate's engine package, not the earlier helper package.
