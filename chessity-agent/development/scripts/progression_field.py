...
from scripts.progression_common import ROOT, RUN, check_stop, digest, save
...
def download():
    ...
    try:
        ...
        for path in sorted([*(ROOT/'runs/daytime-20260909').glob('field-*/state.json'), *(ROOT/'runs/continuation-20260909').glob('field-*/state.json')]):
