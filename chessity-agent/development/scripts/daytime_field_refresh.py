...
TEAMS = {'own': 'b650ca5f-caff-48e7-932a-3ccdb6ab6332',
         'leader': 'b9cbed87-8a3a-437d-9333-1447f68200d1'}
...
def run():
    ...
    try:
        ...
        assert re.search(r'data-href":"/team/' + TEAMS['leader']
            + r'[^}]{0,180}data-podium":1', plain), 'Leader changed; inspect a new observation.'
        ...
        for label in TEAMS:
            ...
            sys.argv = ['scripts.feedback_batch', '--source', str(source), '--out',
                ...
                str(RUN / 'pawn-extrema-01/prototype/models/player-policy.npz')]
            feedback_batch.main()
