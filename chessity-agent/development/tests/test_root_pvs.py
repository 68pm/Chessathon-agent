...
from experiments import root_pvs_core as core
...
def test_every_other_function_and_constant_is_identical_to_selected52():
    root = Path(__file__).resolve().parents[1]
    source = ast.parse((root / 'candidates/compiled-king-coordination-v1/engine/compiled_core.py').read_text())
