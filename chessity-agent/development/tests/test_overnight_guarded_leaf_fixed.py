...
from experiments import overnight_guarded_leaf_fixed_core as core
...
def test_fullmove_sensitive_tt_context(monkeypatch):
    from tests.test_guarded_leaf_context_regression import check_context
    check_context(core, monkeypatch, includes_fullmove=True)
