...
The 35-version delivery is tracked in [the GitHub repository](https://github.com/68pm/Chessathon-agent/tree/main/chessity-agent). See [delivery and download details](../reports/DELIVERY.md).
...
limitations are recorded in `../reports/RATING_AND_300K.md`.
...
Classical submission is preserved. See `../reports/COMBINED_AGENT_TEST.md` for the full
...
line. This is a speculative attacking option; see `../reports/ALIEN_GAMBIT.md`.
...
See `../reports/WITTY_TRAINING_SESSION.md` for the completed training and fresh rating evidence.
...
not a new rating for the agent. See `../reports/ALIEN_RATING_LADDER.md` for the full table,
...
examples. See `../reports/GAME_DOWNLOADER.md` for usage and the recorded user confirmation
...
- `../reports/USER_GUIDE.md`: explanations and practical commands.
- `../reports/TECHNICAL_DISCLOSURE.md`: provenance, results and package audit.
- `../reports/RESULTS.md`: measured experiments and outstanding limitations.
