...
class NeuralValue:
    def __init__(self, path):
        ...
        if w1.shape[0] != 775 or b1.shape != (w1.shape[1],) or w2.shape != (w1.shape[1], len(b2)) or w3.shape != (len(b2), 1) or b3.shape != (1,):
    ...
    def centipawns(self, board):
        ...
        return round(float(600 * np.arctanh(np.clip(value, -.995, .995))))
